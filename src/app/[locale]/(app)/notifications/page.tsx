  ...
  return (
    <main className="min-h-0 flex-1 overflow-auto">
      <div className="flex items-start gap-3 border-b border-line-subtle bg-surface px-4 md:px-7 py-5">
        <div>
          <h1 className="text-title font-semibold text-ink">{t("nav.notifications")}</h1>
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-line-subtle bg-surface px-4 md:px-7 py-2.5">
      ...
      <div className="grid gap-6 px-4 md:px-7 py-6 lg:grid-cols-[minmax(0,1fr)_340px]">
